...
const NewItems = () => {
  // destructuring new in store

  const { title, icon, link, products, subtitle } = newInStore;

  return (
    <section className="section">
      <div className="pl-6 lg:pl-28">
        <div className="flex flex-col lg:flex-row min-h-[400px] overflow-hidden relative">
          {/* text */}
          <div className="flex md:flex-col  items-baseline gap-x-9 mb-6 lg-mb-0 lg:pr-8">
